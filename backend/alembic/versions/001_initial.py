...
def upgrade() -> None:
    ...
    op.create_table(
        "artifacts",
        sa.Column("id", sa.String(36), primary_key=True),
        sa.Column("step_id", sa.String(36), sa.ForeignKey("steps.id", ondelete="CASCADE"), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.String(36), primary_key=True),
        sa.Column("branch_id", sa.String(36), sa.ForeignKey("branches.id", ondelete="CASCADE"), nullable=False),
        sa.Column("job_run_id", sa.String(36), sa.ForeignKey("job_runs.id", ondelete="SET NULL"), nullable=True),
        sa.Column("model_artifact_id", sa.String(36), sa.ForeignKey("artifacts.id", ondelete="SET NULL"), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("branch_id", sa.String(36), sa.ForeignKey("branches.id", ondelete="CASCADE"), nullable=False),
        sa.Column("job_run_id", sa.String(36), sa.ForeignKey("job_runs.id", ondelete="SET NULL"), nullable=True),
        sa.Column("base_model_run_id", sa.String(36), sa.ForeignKey("model_runs.id", ondelete="SET NULL"), nullable=True),
        sa.Column("status", sa.String(32), nullable=False, default="running"),
        sa.Column("n_trials", sa.Integer, nullable=False, default=50),
        sa.Column("completed_trials", sa.Integer, nullable=False, default=0),
        sa.Column("metric", sa.String(64), nullable=False, default="rmse"),
